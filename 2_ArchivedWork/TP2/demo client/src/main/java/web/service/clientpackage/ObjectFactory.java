 ...
 * generated in the web.service.clientpackage package. 
...
public class ObjectFactory {
    ...
    private final static QName _DivideResponse_QNAME = new QName("http://service.web/", "divideResponse");
    private final static QName _Divide_QNAME = new QName("http://service.web/", "divide");
    private final static QName _Substract_QNAME = new QName("http://service.web/", "substract");
    private final static QName _Multiply_QNAME = new QName("http://service.web/", "multiply");
    private final static QName _Add_QNAME = new QName("http://service.web/", "add");
    private final static QName _AddResponse_QNAME = new QName("http://service.web/", "addResponse");
    private final static QName _MultiplyResponse_QNAME = new QName("http://service.web/", "multiplyResponse");
    private final static QName _SubstractResponse_QNAME = new QName("http://service.web/", "substractResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: web.service.clientpackage
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.web/", name = "divideResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.web/", name = "divide")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.web/", name = "substract")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.web/", name = "multiply")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.web/", name = "add")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.web/", name = "addResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.web/", name = "multiplyResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.web/", name = "substractResponse")
